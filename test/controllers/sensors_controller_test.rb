...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { integer: @sensor.integer, string: @sensor.string, string: @sensor.string } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { integer: @sensor.integer, string: @sensor.string, string: @sensor.string } }
