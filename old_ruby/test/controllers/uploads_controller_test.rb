...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { filename: @upload.filename, processed: @upload.processed } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { filename: @upload.filename, processed: @upload.processed } }
